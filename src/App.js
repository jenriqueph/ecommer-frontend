...
import UsuariosRead from './components/UsuarioRead';
    ...
    <div className="App">
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/Registrarse' element={<Cards/>} exact></Route>

          <Route path='/UsuariosCreate' element={<UsuariosCreate/>} exact></Route>
          <Route path='/UsuariosRead' element={<UsuariosRead/>} exact></Route>
          <Route path='/UsuariosList' element={<UsuariosListar/>} exact></Route>
          <Route path='/UsuariosUpdate' element={<UsuariosUpdate/>} exact></Route>
          <Route path='/UsuariosDelete' element={<UsuariosDelete/>} exact></Route>
          ...
          <div className="row">
            <div className="col-lg-3 mb-3">
              ...
              <ul className="list-unstyled small text-muted">
                ...
                <li className="mb-2">Todas Las imagenes y contenidos son de la autoria y propiedad intelectual de <a href="https://www.inditex.com/itxcomweb/es/home" target="_blank">Indetex</a></li>
            ...
            <div className="col-6 col-lg-2 mb-3">
              <h5>Guides</h5>
              <ul className="list-unstyled">
                <li className="mb-2"><a href="https://getbootstrap.com/" target="_blank">Bootstrap</a></li>
                <li className="mb-2"><a href="https://bootswatch.com/" target="_blank">Bootswatch</a></li>
                <li className="mb-2"><a href="https://sweetalert2.github.io/" target="_blank">Sweetalert2</a></li>
                <li className="mb-2"><a href="https://animate.style/" target="_blank">Animate</a></li>
                <li className="mb-2"><a href="https://uigradients.com/" target="_blank">Uigradients</a></li>
                <li className="mb-2"><a href="https://www.mongodb.com/es" target="_blank">MongoDB</a></li>
                <li className="mb-2"><a href="https://nodejs.org/es/" target="_blank">Nodejs</a></li>
                <li className='mb-2'><a href='https://reactjs.org/' target="_blank">React</a></li>
              </ul>
            </div>
            <div className="col-6 col-lg-2 mb-3">
              <h5>Projects</h5>
              <ul className="list-unstyled">
                <li className="mb-2"><a href="https://github.com/" target="_blank">Github</a></li>
              </ul>
            </div>
            <div className="col-6 col-lg-2 mb-3">
              <h5>Community</h5>
              <ul className="list-unstyled">
                <li className="mb-2"><a href="https://trello.com/es/login" target="_blank">Trello</a></li>
              </ul>
            </div>
          </div>
        </div>
